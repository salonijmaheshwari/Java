    ...
    private void createOrder() throws
        ...
        do {
            try {
                ...
                BigDecimal materialCostPerSquareFoot= productSelected.getCostPerSquareFoot();
                BigDecimal materialCost = service.calculateMaterialCost(areaInput,materialCostPerSquareFoot);
                
                BigDecimal labourCostPerSquareFoot=productSelected.getLaborCostPerSquareFoot();
                BigDecimal laborCost = service.calculateLaborCost(areaInput,labourCostPerSquareFoot);
                ...
                service.createNewOrderIfRequired(verifyOrder, orderDateInput, orderNumber, customerNameInputPh, stateAbbreviationInput,
                        taxRate, productTypeInput, areaInput, materialCostPerSquareFoot,labourCostPerSquareFoot, materialCost, laborCost, tax, total);
