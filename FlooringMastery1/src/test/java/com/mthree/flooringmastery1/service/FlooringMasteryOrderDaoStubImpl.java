...
public class FlooringMasteryOrderDaoStubImpl implements FlooringMasteryOrderDao{
    ...
    public FlooringMasteryOrderDaoStubImpl (String dataExportFile, String orderFolder) {
...
//        String [] orderFiles;
//        File f = new File(orderFolder);
        //populates the array with names of files and directories
//        orderFiles = f.list();
        //Say there were also directorys but we need files only
